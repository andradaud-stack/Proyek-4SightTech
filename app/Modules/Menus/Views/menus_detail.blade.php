    ...
    <div class="page-title mb-4">
        <div class="row mb-2">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <a href="{{ route('menus.index') }}" class="btn btn-sm icon icon-left btn-outline-secondary"><i class="fa fa-arrow-left"></i> Kembali </a>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-2">
                        <div class="row kt-detail-grid">
                            ...
                            <div class='col-lg-2'><p>Category</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $menus->category->name ?? '-' }}</p></div>
